...
{
	public sealed class MessageTextEditor
	{
		[JsonIgnore]
		internal ChatId ChatId
		{
			get => ChatId.FromObject(ChatIdentifier);
			set => ChatIdentifier = value.Fetch();
		}

		[JsonPropertyName("chat_id")] public object? ChatIdentifier { get; internal set; }
